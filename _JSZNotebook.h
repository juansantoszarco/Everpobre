...
} JSZNotebookAttributes;

extern const struct JSZNotebookRelationships {
	__unsafe_unretained NSString *notes;
} JSZNotebookRelationships;
...
@property (nonatomic, readonly, strong) JSZNotebookID* objectID;
...
@interface _JSZNotebook (NotesCoreDataGeneratedAccessors)
...
@interface _JSZNotebook (CoreDataGeneratedPrimitiveAccessors)
